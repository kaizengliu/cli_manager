...
from .commands import Group, Option, Command
from .cli import prompt, prompt_pass, prompt_bool, prompt_choices

__all__ = ["Command", "Manager", "Group", "Option",
...
class Manager(object):
    ...
    def __init__(self, usage=None, help=None, description=None, disable_argcomplete=False):
